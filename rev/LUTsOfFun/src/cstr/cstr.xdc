# PIN MAPPING IS NOT IMPORTANT HERE
# The goal is simply to expose all IOs for a complete bitstream, we don't have specific board target.

# Clock
set_property -dict { PACKAGE_PIN E3 IOSTANDARD LVCMOS33 } [get_ports { ACLK }]; # 100 MHZ
